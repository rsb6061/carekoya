...
export function App() {
  return <div>
    <header className="header">
      <a className="brand" href="#"><span>K</span>CareKoya</a>
      <nav><a href="#how">How it works</a><a href="#network">Talent network</a><a href="#schools">For schools</a></nav>
      <a className="button dark" href="mailto:hello@carekoya.com?subject=CareKoya employer access">Find caregivers</a>
    </header>
    ...
    <main>
      <section className="hero">
        ...
        <p>CareKoya helps home-care and senior-care employers find CNAs, HHAs, and caregivers nearby, confirm who is actually looking, screen fit, and turn matches into interviews.</p>
        <div className="actions">
          <a className="button primary big" href="mailto:hello@carekoya.com?subject=Find caregivers">Find caregivers <ArrowRight size={18}/></a>
          <a className="button light big" href="mailto:hello@carekoya.com?subject=Join CareKoya caregiver network">Join the network</a>
        </div>
        <div className="trust">
      ...
      <section className="split" id="how">
        ...
        <div className="copy"><p>Most recruiting products optimize for applicant volume. CareKoya is built around the harder question: <strong>who is reachable, qualified enough for this opening, and interested now?</strong></p><p>Every worker record gets more useful as availability, location, shifts, wage expectations, responses, interviews, and hires are refreshed over time.</p></div>
      </section>

      <section className="section" id="network">
        <div className="section-head"><div className="eyebrow muted">The platform</div><h2>Own the worker relationship, not just the lead.</h2><p>CareKoya is designed as a persistent workforce network with recruiting automation on top.</p></div>
      ...
      <section className="section">
        ...
        <div className="compare">
          ...
          <article className="new"><small>CAREKOYA</small><h3>Here are the people ready to interview.</h3><p>Availability is refreshed. Outreach and screening are automated. Employers see response and qualification status. Every interaction strengthens the network.</p></article>
        </div>
      </section>

      <section className="cta"><div><div className="eyebrow">Care workforce infrastructure</div><h2>Your next caregiver may already be looking.</h2></div><a className="button cream big" href="mailto:hello@carekoya.com?subject=CareKoya employer access">Start recruiting <ArrowRight size={18}/></a></section>
    </main>

    <footer><a className="brand" href="#"><span>K</span>CareKoya</a><p>Built for the direct-care workforce.</p><p>© 2026 CareKoya</p></footer>
  </div>
}